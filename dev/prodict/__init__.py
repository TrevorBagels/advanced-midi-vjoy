'''
Original prodict repository: https://github.com/ramazanpolat/prodict

This is a fork of prodict, making it compatible with python 3.9
It also supports data types such as enums and datetime objects (the original prodict only supports fundamental data types)
line 142 get_constructor is where I added support for additional data types
